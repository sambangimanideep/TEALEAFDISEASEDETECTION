...
import com.example.tealeaf.ml.Tea // Replace with your actual model class name
...
class MainActivity : AppCompatActivity() {
    ...
    private fun processImage(bitmap: Bitmap) {
        ...
        val model = Tea.newInstance(this) // Replace with your model's actual name
    ...
    private fun getPredictedClass(probabilities: FloatArray): String {
        val labels = arrayOf("red_spot", "helopeltis", "healthy", "gray_blight", "brown_blight", "algal_spot")
